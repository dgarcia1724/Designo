function GraphicDesignViewProjects() {
  return (
    <a href="#" className="">
      <div className="bg-[url('src/designo-multi-page-website/starter-code/assets/home/mobile/image-graphic-design.jpg')] bg-cover rounded-[15px] overflow-hidden relative">
