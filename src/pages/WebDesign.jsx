...
const webDesignData = [
  {
    id: 1,
    url: "src/assets/web-design/desktop/image-express.jpg",
    title: "EXPRESS",
    description: "A multi-carrier shipping website for ecommerce businesses",
  },
  {
    id: 2,
    url: "src/assets/web-design/desktop/image-transfer.jpg",
    title: "TRANSFER",
    description:
  ...
  {
    id: 3,
    url: "src/assets/web-design/desktop/image-photon.jpg",
    title: "PHOTON",
    description:
  ...
  {
    id: 4,
    url: "src/assets/web-design/desktop/image-builder.jpg",
    title: "BUILDER",
    description:
  ...
  {
    id: 5,
    url: "src/assets/web-design/desktop/image-blogr.jpg",
    title: "BLOGR",
    description:
  ...
  {
    id: 6,
    url: "src/assets/web-design/desktop/image-camp.jpg",
    title: "CAMP",
    description:
